...
#
#         input_query = np.array([[Age, Gender, Total_Bilirubin, Direct_Bilirubin, Alkaline_Phosphotase, Alamine_Aminotransferase,
...
#     app.run(debug=True)
# from flask import Flask, jsonify, request, render_template, testing
# import pickle
# import numpy as np
#
#
